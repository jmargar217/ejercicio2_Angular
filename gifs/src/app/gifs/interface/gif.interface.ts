...
export interface SearchGifsInterface {
  data:       Gif[];
...
export class Convert {
  public static toWelcome(json: string): SearchGifsInterface {
      return cast(JSON.parse(json), r("Welcome"));
  }

  public static welcomeToJson(value: SearchGifsInterface): string {
